#!/usr/bin/env bash
# sbatch --nodes=1 --time=10:00:00 --mem=32G --cpus-per-task=4 --gres=gpu:1 --account=def-ssanner SV_cifar10_1.sh
# sbatch --nodes=1 --time=10:00:00 --mem=32G --cpus-per-task=4 --gres=gpu:1 --account=def-ssanner SV_cifar10_2.sh
# sbatch --nodes=1 --time=10:00:00 --mem=32G --cpus-per-task=4 --gres=gpu:1 --account=def-ssanner SV_cifar10_3.sh
# sbatch --nodes=1 --time=10:00:00 --mem=32G --cpus-per-task=4 --gres=gpu:1 --account=def-ssanner SV_cifar10_4.sh
# sbatch --nodes=1 --time=10:00:00 --mem=32G --cpus-per-task=4 --gres=gpu:1 --account=def-ssanner SV_cifar10_5.sh
# sbatch --nodes=1 --time=10:00:00 --mem=32G --cpus-per-task=4 --gres=gpu:1 --account=def-ssanner SV_cifar10_6.sh
sbatch --nodes=1 --time=10:00:00 --mem=32G --cpus-per-task=4 --gres=gpu:1 --account=def-ssanner SV_cifar10_7.sh
sbatch --nodes=1 --time=10:00:00 --mem=32G --cpus-per-task=4 --gres=gpu:1 --account=def-ssanner SV_cifar10_8.sh
